...
2. Example of the Widget (size: 300x250)
3. Example of the Resume Builder, which opens in a modal ("thickbox") window via the link produced using the livecareer_affiliate_link shortcode
4. Example of the full-page Resume Builder
